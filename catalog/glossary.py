...
GLOSSARY: dict[str, list[str]] = {
    ...
    "requisitions": ["purchase_req"],
    "purchase requisitions": ["purchase_req"],
    "warehouse locations": ["whse_loc"],
    "bin locations": ["whse_loc"],
    "units of measure": ["item_uom"],
    "uom": ["item_uom"],
    "leave types": ["leave_type_lkp"],
    "countries": ["country_lkp"],
    "customer addresses": ["cust_addr"],
    "shipping addresses": ["cust_addr"],
    "fiscal periods": ["fiscal_period"],
    "accounting periods": ["fiscal_period"],
    "interactions": ["interaction_log"],
    "touchpoints": ["interaction_log"],
    "vendor contacts": ["vendor_contact"],
    "po approvals": ["po_approval_hist"],
    "purchase order approvals": ["po_approval_hist"],
    "order status history": ["ord_status_hist"],
    "deal stage history": ["opportunity_stage_hist"],
    "opportunity stages": ["opportunity_stage_hist"],
    "account contacts": ["account_contact_map"],
    "campaign members": ["campaign_member_map"],
}
